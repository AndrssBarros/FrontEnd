  ...
  return (
    <div className="d-grid align-items-center justify-content-center" style={{ height: "100vh" }}>
      <div className="border rounded p-5" style={{ backgroundColor: "#5f4888", borderRadius: "25px" }}>
        <Form style={{ color: "#FFFFFF", margin: "5px" }} onSubmit={{backgroundColor: "#5f4688", borderRadius: "25px"}}>
      ...
      <div>
        <Table striped border="true" hover className="border rounded p-5" size="md" style={{ backgroundColor: "#FFFFFF" }}>
          <thead>
            <tr>
              <th>Nome</th>
              <th>Curso</th>
          ...
          <tbody>
            {alunos.map((item) => {
              return(
                ...
                ( onEdit === item.id ? {
                  <FaTrash onClick={() => cancelEdit(item.id)}/> 
                } {
